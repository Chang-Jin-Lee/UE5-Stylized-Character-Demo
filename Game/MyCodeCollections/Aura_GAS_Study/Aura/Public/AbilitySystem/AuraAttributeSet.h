...
template<class T>
// using TStaticFuncPtr = typename TBaseDynamicMulticastDelegate<T, FDefaultDelegateUserPolicy>::FFuncPtr;
...
public:
	UAuraAttributeSet();
	virtual void GetLifetimeReplicatedProps(TArray<class FLifetimeProperty>& OutLifteimeProps) const override;
	...
	UFUNCTION()
	void OnRep_CriticalHitDamage(const FGameplayAttributeData& OldCriticalHitDamange) const;
