...
UAuraAttributeSet::UAuraAttributeSet()
{
	...
	TagsToAttributes.Add(GameplayTags.Attributes_Primary_Inteligence, GetInteligenceAttribute);
...
void UAuraAttributeSet::PostGameplayEffectExecute(const struct FGameplayEffectModCallbackData& Data)
{
	...
	// {
	// 	UE_LOG(LogTemp, Error, TEXT("Health from GetHealth() : %f"), GetHealth());
	// 	UE_LOG(LogTemp, Error, TEXT("Magnitude : %f"), Data.EvaluatedData.Magnitude);
	// }
	...
	if(Data.EvaluatedData.Attribute == GetHealthAttribute())
	{
		...
		GEngine->AddOnScreenDebugMessage(1,3.0f, FColor::Red, FString::Printf(TEXT("Change Health on %s, Health : %f"), *Props.TargetAvatarActor->GetName(), GetHealth()));
	}
	...
	if (Data.EvaluatedData.Attribute == GetIncomingDamageAttribute())
	{
		...
		if (LocalIncomingDamage > 0.0f)
		{
			...
			{
				if (ICombatInterface* CombatInterfac = Cast<ICombatInterface>(Props.TargetAvatarActor))
				{
					CombatInterfac->Dead();
				}
			}
