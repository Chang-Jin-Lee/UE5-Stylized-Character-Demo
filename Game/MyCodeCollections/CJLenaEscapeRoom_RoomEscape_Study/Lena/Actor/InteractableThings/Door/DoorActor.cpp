...
{
	if(TObjectPtr<UInteractWidget> Widget = Cast<UInteractWidget>(WidgetComponent))
	{
...
void ADoorActor::OpenFail()
{
	...
	if(TObjectPtr<UUserWidget> Widget = WidgetComponent->GetWidget())
	{
		if(TObjectPtr<UInteractWidget> InteractWidget = Cast<UInteractWidget>(Widget))
		{
